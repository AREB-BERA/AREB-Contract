...
export interface IHenloDexRouterV1Interface extends utils.Interface {
  functions: {
...
export interface IHenloDexRouterV1 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IHenloDexRouterV1Interface;
